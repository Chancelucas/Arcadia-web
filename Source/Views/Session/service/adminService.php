  ...
  <div class="container_service_admin">
    <?php foreach ($services as $service) : ?>
      ...
      <div class="service_creaded_admin">
        <div class="item_service_admin title_service_admin"><?= $service->name; ?></div>
        <div class="item_service_admin"><?= $service->description; ?></div>
        ...
        <div class=" btn_gestion_service_admin">
          <form method="POST" action="/adminService/deleteService/<?= $service->id_Service; ?>">
            <button type="submit" class="delete-service-btn-admin" name="deleteService">Supprimer</button>
          </form>

          <a href="/adminUpdateService/index/<?= $service->id_Service ?>" class="link_update_service_admin">Modifier</a>
