...
<body>
    <?php
    require_once '../../templates/admin/admin_navbar.php';
    ...
    <div id="form_create_admin">
        <?php
        require_once '../../templates/admin/form_add_employee.php';
        ?>
    </div>
    <?php
        ...
        <div id="container_user_admin">
            <div id="user_creaded_admin">
                ...
                <div class="btn_gestion_user">
                    <a href="/app/controllers/crud/admin/ModifyUser.php?userId=<?= $user['userId']; ?>"><img src="/assets/images/icons/modifier.svg" alt="btn-supprier"></a>
                    <a href="/app/controllers/crud/admin/DeleteUser.php?userId=<?= $user['userId']; ?>"><img src="/assets/images/icons/supprier.svg" alt="btn-supprier"></a>
